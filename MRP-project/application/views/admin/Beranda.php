			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="card card-stats">
					<div class="card-header card-header-info card-header-icon">
						...
						<p class="card-category">Staff Status</p>
						<h3 class="card-title counter">Staff Status</h3>
					</div>
					<div class="card-footer">
						<div class="stats">
							<canvas id="staffStatusChart" width="200" height="150"></canvas>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="card card-stats">
					<div class="card-header card-header-warning card-header-icon">
						...
						<p class="card-category">Machine Status</p>
						<h3 class="card-title counter">Machine Status</h3>
					</div>
					<div class="card-footer">
						<div class="stats">
							<canvas id="machineStatusChart" width="200" height="150"></canvas>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	const staffStatusData = {
		...
		datasets: [{
			label: 'Staff Status',
			data: [<?= $readyCount ?>, <?= $scheduledCount ?>],
			backgroundColor: ['lightgreen', 'limegreen'] //
		}]
	};
	...
	new Chart(staffStatusCtx, staffStatusConfig);

	// Machine Status Chart
	// Machine Status Chart
	const machineStatusData = {
		labels: <?= json_encode($machineLabels) ?>,
		datasets: [{
			label: 'Machine Status',
			data: [<?= $workingCount ?>, <?= $idleCount ?>],
			backgroundColor: ['lightblue', 'skyblue'] // 
		}]
	};
	...
	new Chart(machineStatusCtx, machineStatusConfig);
</script>
