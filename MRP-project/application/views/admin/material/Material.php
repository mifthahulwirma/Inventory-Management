        ...
        <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
            <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
                ...
                <div class="col-4 text-end">
                    <a href="<?= site_url('admin/material/addmaterial'); ?>" class="btn bg-gradient mb-0" style="background-color:#5e2fd5;color:#fff">Add New Material</a>
                </div>
            </div>
        </div>
</div>
            ...
            <div class="card-body p-3">
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Staff</th>
            ...
            <div class="card-body pt-4">
                ...
                <table id="table-data" class="table align-items-center justify-content-center mb-0">
                    ...
                    <?php if (!empty($materials)) : $i = 1; foreach ($materials as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold">Rp <?= $value->price?> </span>
                        </td>
                        </tr>
                        <?php  endforeach; endif;?>
                    </tbody>
