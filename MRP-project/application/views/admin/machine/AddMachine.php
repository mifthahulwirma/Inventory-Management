            ...
            <div class="card-header card-header-primary">
                ...
                <div class="d-flex pt-4" method="post">
                            ...
                            <form class="pt-4" action="<?= site_url('admin/addMachine'); ?>" method="post">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <select class="selectpicker form-control" name="id_planshift" data-style="btn btn-link" data-live-search="true">
                                        ...
                                        <?php if (!empty($planshift)) : ?>
                                            <?php foreach ($planshift as $value) : ?>
                    ...
                    <div class="col-4">
                        ...
                        <div class="d-flex">
                            <div class="pt-2 pl-2">
                                <a class="btn btn-outline-dark btn-sm mb-0" href="<?= site_url('admin/production/detailProduction'); ?>">Back</a>
                            </div>
                            <div class="pt-2 pl-2">
