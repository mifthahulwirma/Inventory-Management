            ...
            <div class="card-header card-header-primary">
                ...
                <div class="d-flex pt-4" method="post">
                        ...
                        <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                            <form class="pt-4" action="<?= site_url('admin/updatestaff'); ?>" method="post">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <!-- <span>Status</span></br>
                                    <div class="input-group input-group-dynamic mb-4">
                                        <input type="hidden" name="st_status" value="<?= $detail['st_status']; ?>"> -->
                                        <!-- <input type="hidden" name="mc_stats" value="2"> -->

                                        <!-- <select class="selectpicker form-control" name="st_status" data-style="btn btn-link" data-live-search="true">
                                            <option disabled>Select Status</option>
                                            <option value="0" <?= ($detail['st_status'] == 0) ? 'selected' : ''; ?>>Ready</option>
                                            <option value="1" <?= ($detail['st_status'] == 1) ? 'selected' : ''; ?>>Scheduled</option>
                                        </select>
                                    </div> -->
                    ...
                    <div class="col-4">
                        ...
                        <div class="d-flex">
                            <div class="pt-2 pl-2">
                                <a class="btn btn-outline-dark btn-sm mb-0" href="<?= site_url('admin/staff'); ?>">Back</a>
                            </div>
                            <div class="pt-2 pl-2">
