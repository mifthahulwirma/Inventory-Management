	...
	<div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
		<div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
			...
			<div class="col-4 text-end">
				<a href="<?= site_url('admin/staff/addstaff'); ?>" class="btn bg-gradient mb-0" style="background-color:#5e2fd5;color:#fff">Add Staff</a>
			</div>
		</div>
	</div>
</div>
									...
									<tr>
										...
										<td class="pl-4">
											<span class="text-sm font-weight-bold">
												<?php if ($value->st_status == 0) : ?>
													<?= "Ready"; ?>
												<?php elseif ($value->st_status == 1) : ?>
													<?= "Scheduled"; ?>
												<?php endif; ?>
											</span>
